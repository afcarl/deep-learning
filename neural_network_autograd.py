# neural_network_autograd.py
# implementation of neural network with PyTorch variable (tutorial from PyTorch)
...
# Setting requires_grad=False indicates that we do not need to compute gradinets
...
plt.title('PyTorch Autograd Neural Network')
